...
function validateConfig() {
  ...
  if (config2.REDIS_URL && config2.REDIS_URL !== "redis://127.0.0.1:6379") {
    if (!config2.REDIS_URL.startsWith("redis://") && !config2.REDIS_URL.startsWith("rediss://")) {
      console.warn(`Warning: REDIS_URL format may be invalid: ${config2.REDIS_URL}. Expected format: redis:// or rediss://`);
    }
  }
  return config2;
}
