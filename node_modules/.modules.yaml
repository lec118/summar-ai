...
hoistedDependencies:
  ...
  /nanoid/3.3.11:
    nanoid: private
  /next/14.2.7(react-dom@18.3.1)(react@18.3.1):
    next: private
  ...
  /uuid/11.1.0:
    uuid: private
  /vite-node/2.1.9(@types/node@20.19.23):
    vite-node: private
  /vite/5.4.21(@types/node@20.19.23):
    vite: private
  /vitest/2.1.9(@types/node@20.19.23):
    vitest: private
...
pendingBuilds: []
prunedAt: Fri, 31 Oct 2025 01:31:26 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: C:\Users\Administrator\Desktop\Summa AI\node_modules\.pnpm
